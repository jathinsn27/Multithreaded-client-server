            ...
            <div class="o-wrap--content">
               <nav role="navigation" id="breadcrumb" class="o-nav--breadcrumb clearfix" aria-label="breadcrumb">
                  <ol class="o-nav--breadcrumb__menu"><!--Text value is blank-->
                     ...
                     <li class="o-nav--breadcrumb__item"><a href="https://www.sjsu.edu/campus-life/">Campus Life</a></li>
               ...
               <div class="o-wrap o-wrap--media-type-hero u-bg--dark ou-error--snippet">
                  <div class="o-media o-media--hero">
                     <div class="o-media__frame">
                        <div class="o-media__graphic"><img class="o-media__img" src="/_images/safety/ADV_spartan-safety-dschmitz_2.jpg" alt="Spartans for Safety"></div>
                     </div>
               ...
               <div class="o-wrap o-wrap--media-postcard u-bg--dark ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-media o-media--postcard">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="/_images/news/upd-safety-officer-badge_dschmitz__IMG_WEB.jpg" alt="A close up of a police uniform badge."></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy">
                                 <p class="o-media__heading"><a class="o-media__link" href="/police/index.php">University Police Department (UPD)</a></p>
                           ...
                           <div class="o-media__frame">
                              <div class="o-media__copy">
                                 ...
                                 <p class="o-media__text">For facility issues, please submit a service ticket or call 408-924-1990 for all emergency
                                    requests.</p>
                                 <p class="o-c2a"><a class="o-c2a__link" href="/fdo/request-forms/index.php">Request Facility Service</a></p>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="o-wrap o-wrap--cardholder o-wrap--grid-component--DISABLE u-bg--triangles-down-small u-color--paseo-gray u-bg--fade-radial ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-cardholder u-gridgap-half">
                        <div class="o-card"><img class="o-card__img" src="/_images/news/Title-IX-campus_IMG_WEB.jpg" alt="Students gathered together on the grass."><div class="o-card__info u-gradientbar--card">
                        ...
                        <div class="o-card"><img class="o-card__img" src="/_images/people/ADV_food-pantry-opening-dschmitz-041819-2404.jpg" alt="Staff members working at the Food Pantry."><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/sjsucares/index.php">SJSU Cares</a></p>
                        ...
                        <div class="o-card"><img class="o-card__img" src="/_images/safety/ADV_spartan-safety-car-campus-dschmitz_1.jpg" alt="Spartan Safety escort is available up to two blocks from campus."><div class="o-card__info u-gradientbar--card">
                           ...
                           <p class="o-c2a--card"><a class="o-c2a--card__link" href="/police/services/escort.php"><span class="o-c2a--card__text">Request a Safety Escort</span><span class="o-c2a--card__arrow"></span></a></p>
                        </div>
                        <div class="o-card">
                           <div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/counseling/index.php">Mental Health Services</a></p>
                        ...
                        <div class="o-card">
                           <div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/up/mycareer/equal-opportunity/student-discrimination-and-harassment-complaints/index.php">Discrimination and Harassment</a></p>
                        ...
                        <div class="o-card">
                           <div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/studentconduct/index.php">Student Conduct Code Violations</a></p>
                        ...
                        <div class="o-card">
                           <div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/bit/index.php">Spartans in Distress</a></p>
                        ...
                        <div class="o-card">
                           <div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/studentconduct/conduct-processes/student-organizations/hazing.php">Hazing Prevention and Response</a></p>
