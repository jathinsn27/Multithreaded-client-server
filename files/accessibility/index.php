...
<!-- End Google Tag Manager -->	<a id="skiplink" href="#sjsu-maincontent" class="show-for-sr">Skip to main content</a><header id="sjsu-header" class="o-region o-region--header" role="banner">
		<div class="o-wrap--globalnav u-bg--dark">
         ...
         <div class="o-wrap--content ">
            <h1 id="maintitle" class="o-title o-title--site show-for-large"><a class="o-title--site__link" href="https://www.sjsu.edu/accessibility/index.php">Accessibility at SJSU</a></h1><span class="show-for-large">&nbsp;</span></div>
      </header>
      ...
      <nav id="sitenav-mobile" class="top-bar o-nav--site" data-topbar="data-topbar" role="navigation" aria-label="Site nav menu for small screens">
         <div class="top-bar-title" data-responsive-toggle="sitenav-mobile-menu" data-hide-for="medium">
            <div class="o-nav--site__title">
               <h1><a class="o-title o-title--site-mobile  u-adjust-title-height" href="https://www.sjsu.edu/accessibility/index.php">Accessibility at SJSU</a></h1>
            </div>
         ...
         <div id="sitenav-mobile-menu" style="min-width:100%">
            <ul class="vertical menu accordion-menu" data-accordion-menu="data-accordion-menu" data-submenu-toggle="data-submenu-toggle">
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/accessibility/about-us/index.php">About Us</a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/accessibility/about-us/index.php">About Us</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/accessibility/about-us/ati.php">Accessible Technology Initiative</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/accessibility/about-us/policy-guidelines.php">Policy Guidelines</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/accessibility/about-us/ucac.php">Council on Accessibility, Compliance &amp; Accommodati</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/accessibility/about-us/accessibility-at-sjsu-newsletter.php">Accessibility @ SJSU Newsletter</a></li>
                  </ul>
               </li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/accessibility/your-role/index.php">Your Role</a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/accessibility/your-role/index.php">Your Role</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/accessibility/your-role/student_accomodation.php">I Am a Student Who Needs an Accommodation</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/accessibility/your-role/employee_accomodation.php">I Am an Employee Who Needs an Accommodation</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/accessibility/your-role/ally.php">I Want to be an Ally</a></li>
                  </ul>
               </li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/accessibility/accessible-content/index.php">Creating Accessible Content</a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/accessibility/accessible-content/index.php">Creating Accessible Content</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/accessibility/accessible-content/guidelines.php">Guidelines for Creating Accessible Content</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/accessibility/accessible-content/tools.php">Tools for Creating Accessible Content</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/accessibility/accessible-content/global_accessibility_awareness_day.php">Global Accessibility Awareness Day 2024</a></li>
                  </ul>
               </li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/accessibility/report-a-concern/index.php">Report an Accessibility Concern</a></li>
            </ul>
         </div>
      </nav>
   </div>
   ...
   <div class="o-wrap--content">
      <nav id="sitenav" class="o-nav--site" role="navigation" aria-label="Site nav menu">
         <ul class="dropdown menu" data-dropdown-menu="data-dropdown-menu">
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/accessibility/about-us/index.php">About Us</a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/accessibility/about-us/ati.php" class="gtm-nav--site">Accessible&nbsp;Technology&nbsp;Initiative</a></li>
                  <li class="o-nav--site__item"><a href="/accessibility/about-us/policy-guidelines.php" class="gtm-nav--site">Policy&nbsp;Guidelines</a></li>
                  <li class="o-nav--site__item"><a href="/accessibility/about-us/ucac.php" class="gtm-nav--site">Council&nbsp;on&nbsp;Accessibility,&nbsp;Compliance&nbsp;&amp;&nbsp;Accommodations</a></li>
                  <li class="o-nav--site__item"><a href="/accessibility/about-us/accessibility-at-sjsu-newsletter.php" class="gtm-nav--site">Accessibility&nbsp;@&nbsp;SJSU&nbsp;Newsletter</a></li>
               </ul>
            </li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/accessibility/your-role/index.php">Your Role</a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/accessibility/your-role/student_accomodation.php" class="gtm-nav--site">I&nbsp;Am&nbsp;a&nbsp;Student&nbsp;Who&nbsp;Needs&nbsp;an&nbsp;Accommodation</a></li>
                  <li class="o-nav--site__item"><a href="/accessibility/your-role/employee_accomodation.php" class="gtm-nav--site">I&nbsp;Am&nbsp;an&nbsp;Employee&nbsp;Who&nbsp;Needs&nbsp;an&nbsp;Accommodation</a></li>
                  <li class="o-nav--site__item"><a href="/accessibility/your-role/ally.php" class="gtm-nav--site">I&nbsp;Want&nbsp;to&nbsp;be&nbsp;an&nbsp;Ally</a></li>
               </ul>
            </li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/accessibility/accessible-content/index.php">Creating Accessible Content</a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/accessibility/accessible-content/guidelines.php" class="gtm-nav--site">Guidelines&nbsp;for&nbsp;Creating&nbsp;Accessible&nbsp;Content</a></li>
                  <li class="o-nav--site__item"><a href="/accessibility/accessible-content/tools.php" class="gtm-nav--site">Tools&nbsp;for&nbsp;Creating&nbsp;Accessible&nbsp;Content</a></li>
                  <li class="o-nav--site__item"><a href="/accessibility/accessible-content/global_accessibility_awareness_day.php" class="gtm-nav--site">Global&nbsp;Accessibility&nbsp;Awareness&nbsp;Day&nbsp;2024</a></li>
               </ul>
            </li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/accessibility/report-a-concern/index.php">Report an Accessibility Concern</a></li>
         </ul>
      </nav>
   </div>
                  ...
                  <div class="o-wrap--content">
                     <div class="o-media o-media--postcard">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="/accessibility/pics/122023_ati/landing%20page%20photo.jpg" alt="students in library sitting at desk"></div>
                        </div>
               ...
               <div class="o-wrap o-wrap--cardholder o-wrap--grid-component--DISABLE u-bg--triangles-down-small u-color--paseo-gray u-bg--fade-radial ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-cardholder u-gridgap-half">
                        <div class="o-card"><img class="o-card__img" src="/accessibility/pics/122023_ati/2%20student%20needs%20accomodations.jpg" alt="students in classroom"><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/accessibility/your-role/student_accomodation.php">I Am a Student Who Needs an Accommodation</a></p>
                              
                              <p class="o-card__copy">Accessibility is a key component of student success, and SJSU has a range of resources
                                 for students.</p>
                              </div>
                        </div>
                        <div class="o-card"><img class="o-card__img" src="/accessibility/pics/122023_ati/2_employeeaccomodations.jpg" alt="employee with medium sized dog"><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/accessibility/your-role/employee_accomodation.php">I Am an Employee Who Needs an Accommodation</a></p>
                        ...
                        <div class="o-card"><img class="o-card__img" src="/accessibility/pics/122023_ati/5%20I%20Want%20to%20be%20an%20Ally.jpg" alt="two people sitting at a desk"><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/accessibility/your-role/ally.php">I Want to be an Ally</a></p>
                        ...
                        <div class="o-card"><img class="o-card__img" src="/accessibility/pics/122023_ati/4%20Guidelines%20for%20Creating%20Accessible%20Content.jpg" alt="teacher lecturing a class"><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/accessibility/accessible-content/guidelines.php">Guidelines for Creating Accessible Content</a></p>
                        ...
                        <div class="o-card"><img class="o-card__img" src="/accessibility/pics/122023_ati/6%20Tools%20for%20Creating%20Accessible%20Content.jpg" alt="student and sjsu employee sitting at a computer"><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/accessibility/accessible-content/tools.php">Tools for Creating Accessible Content</a></p>
                              
                              <p class="o-card__copy">SJSU offers numerous resources that provide support for you to use accessible tools.</p>
                              </div>
                        </div>
                        <div class="o-card"><img class="o-card__img" src="/accessibility/pics/122023_ati/7%20About%20Us.jpg" alt="two people who attended a gathering looking at a laptop"><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/accessibility/about-us/index.php">About Us</a></p>
               ...
               <div class="o-wrap o-wrap--media-type-highlight u-bg--dark ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-media o-media--highlight">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="/cfeti/pics/ChallengeBanner2024.png" alt="Fix Your Content Day SJSU Document Accessibility Challenge"></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy">
