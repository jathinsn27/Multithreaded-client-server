...
<!-- site: www --><script type="text/javascript">
			var page_url="https://www.sjsu.edu/facts-and-accomplishments/index.php";
		</script><title>Facts and Accomplishments</title>
      <meta name="Description" content="The Facts and Accomplishments site provides facts about the university, students, faculty, alumni, features SJSU rankings,faculty awards and fellowships and Olympic medalists."><script>
					var currentNavigationStart = "/facts-and-accomplishments/";
				</script></head>
										...
										<ul class="amm-o-nav__menu">
											...
											<li class="amm-o-nav__group">
												...
												<ul class="amm-o-nav__list">
													...
													<li class="amm-o-nav__item"><a href="index.php">Facts and <br />Accomplishments</a></li>
							...
							<ul class="vertical menu accordion-menu" data-accordion-menu="data-accordion-menu" data-submenu-toggle="data-submenu-toggle">
								...
								<li class="o-nav--global__item">
									...
									<ul class="menu vertical">
										...
										<li class="o-nav--global__item o-nav--global__item--nested"><a href="index.php">Facts and <br />Accomplishments</a></li>
            ...
            <div class="o-wrap--content">
               <nav role="navigation" id="breadcrumb" class="o-nav--breadcrumb clearfix" aria-label="breadcrumb">
                  <ol class="o-nav--breadcrumb__menu"><!--Text value is blank-->
                     ...
                     <li class="o-nav--breadcrumb__item"><a aria-current="page">Facts and Accomplishments</a></li>
                  </ol>
               </nav>
            </div>
         </div>
         <div class="o-wrap--content ">
            <h1 id="maintitle" class="o-title o-title--site show-for-large"><a class="o-title--site__link" href="index.html">Facts and Accomplishments</a></h1><span class="show-for-large">&nbsp;</span></div>
      </header>
      ...
      <nav id="sitenav-mobile" class="top-bar o-nav--site" data-topbar="data-topbar" role="navigation" aria-label="Site nav menu for small screens">
         <div class="top-bar-title" data-responsive-toggle="sitenav-mobile-menu" data-hide-for="medium">
            <div class="o-nav--site__title">
               <h1><a class="o-title o-title--site-mobile  u-adjust-title-height" href="index.html">Facts and Accomplishments</a></h1>
            </div>
         ...
         <div id="sitenav-mobile-menu" style="min-width:100%">
            <ul class="vertical menu accordion-menu" data-accordion-menu="data-accordion-menu" data-submenu-toggle="data-submenu-toggle">
               <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="https://www.sjsu.edu/facts-and-accomplishments/facts.php">By the Numbers</a></li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="https://www.sjsu.edu/facts-and-accomplishments/accomplishments.php">Accomplishments</a></li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="https://www.sjsu.edu/facts-and-accomplishments/pride-points.php">Spartan Pride Points</a></li>
            </ul>
         </div>
      </nav>
   </div>
   ...
   <div class="o-wrap--content">
      <nav id="sitenav" class="o-nav--site" role="navigation" aria-label="Site nav menu">
         <ul class="dropdown menu" data-dropdown-menu="data-dropdown-menu">
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="https://www.sjsu.edu/facts-and-accomplishments/facts.php">By&nbsp;the&nbsp;Numbers</a></li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="https://www.sjsu.edu/facts-and-accomplishments/accomplishments.php">Accomplishments</a></li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="https://www.sjsu.edu/facts-and-accomplishments/pride-points.php">Spartan&nbsp;Pride&nbsp;Points</a></li>
         </ul>
      </nav>
   </div>
                  ...
                  <div class="o-wrap--content">
                     <div class="o-media o-media--postcard">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/news/featured_news_spring21-report-braven_021121.jpg" alt="A diverse group of graduates."></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy">
                                 <p class="o-media__heading">Who We Are and What We’ve Achieved</p>
                                 <p class="o-media__text">Discover the storied history of SJSU’s past and the current iteration of the university
                                    through the Facts and Accomplishments pages. This site showcases SJSU by the numbers
                                    and highlights a multitude of successes, from dominance at the world’s biggest athletics
                                    stage—the Olympics—to placement at the top of higher education’s most notable rankings.
                                    </p>
                              </div>
                           </div>
                        </div>
               ...
               <div class="o-wrap o-wrap--cardholder o-wrap--grid-component--DISABLE u-bg--triangles-down-small u-color--paseo-gray u-bg--fade-radial ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-cardholder u-gridgap-half">
                        <div class="o-card"><img class="o-card__img" src="https://www.sjsu.edu/_images/news/110619_sjsu-downtown_WEB_IMGs_02.jpg" alt="Aerial view of SJSU."><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="https://www.sjsu.edu/facts-and-accomplishments/facts.php">By the Numbers</a></p>
                              
                              <p class="o-card__copy">With more than 350,000 current and former Spartans, SJSU’s transformative influence
                                 extends far beyond the downtown San José campus. Here’s San José State University
                                 by the numbers.</p>
                              </div>
                        </div>
                        <div class="o-card"><img class="o-card__img" src="https://www.sjsu.edu/_images/news/091520-sjsu-money-magazine-ranking.jpg" alt="SJSU graduates jumping up in the air."><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="https://www.sjsu.edu/facts-and-accomplishments/accomplishments.php">Our Accomplishments</a></p>
                              
                              <p class="o-card__copy">From topping the charts in national rankings to taking home the gold on the world's
                                 biggest athletic stage, SJSU has often reached the pinnacle of excellence since 1857.</p>
                              </div>
                        </div>
                        <div class="o-card"><img class="o-card__img" src="https://www.sjsu.edu/facts-and-accomplishments/pics/032423-pride-points_IMG_WEB.jpg" alt="Students throwing paper airplanes."><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="https://www.sjsu.edu/facts-and-accomplishments/pride-points.php">Spartan Pride Points</a></p>
                              
                              <p class="o-card__copy">What happens in Silicon Valley changes the world — and SJSU is the university changing
                                 Silicon Valley. Discover the ways Spartans are impacting the campus and beyond.</p>
                              </div>
                        </div>
                     </div>
                  </div>
...
<!-- /Slate Ping Analytics -->      <div id="hidden" style="display:none;"><a href="https://a.cms.omniupdate.com/11/?skin=sjsu&amp;account=sjsu&amp;site=www&amp;action=de&amp;path=/facts-and-accomplishments/index.pcf" target="_top" rel="nofollow" id="de">Last Updated Mar 6, 2024</a></div>
   </body>
</html>