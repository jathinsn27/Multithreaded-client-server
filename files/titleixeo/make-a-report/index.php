...
<!-- End Google Tag Manager -->	<a id="skiplink" href="#sjsu-maincontent" class="show-for-sr">Skip to main content</a><header id="sjsu-header" class="o-region o-region--header" role="banner">
            ...
            <div class="o-wrap--content">
               <nav role="navigation" id="breadcrumb" class="o-nav--breadcrumb clearfix" aria-label="breadcrumb">
                  <ol class="o-nav--breadcrumb__menu"><!--Text value is blank-->
                     ...
                     <li class="o-nav--breadcrumb__item"><a href="https://www.sjsu.edu/titleixeo/">Office for Title IX and Equal Opportunity</a></li>
   ...
   <nav id="sjsu-localnav" class="o-nav--local hide-for-small-only" role="navigation" aria-label="Local nav menu">
      <ul class="vertical menu">
         <li class="o-nav--local__item"><a href="/titleixeo/get-help/index.php" class="gtm-nav--local">Get Help</a><ul class="nested vertical menu">
               <li class="o-nav--local__item"><a href="/titleixeo/get-help/our-services/index.php" class="gtm-nav--local">Our Services</a><ul class="nested vertical menu">
                     <li class="o-nav--local__item"><a href="/titleixeo/get-help/our-services/definitions-of-prohibited-conduct.php" class="gtm-nav--local">Definitions of Prohibited Conduct</a></li>
                  </ul>
               </li>
               <li class="o-nav--local__item"><a href="/titleixeo/get-help/request-a-training/index.php" class="gtm-nav--local">Request a Training</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/get-help/privacy/index.php" class="gtm-nav--local">Privacy</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/get-help/faqs/index.php" class="gtm-nav--local">FAQs</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/get-help/policy-procedures/index.php" class="gtm-nav--local">Policy &amp; Procedures</a><ul class="nested vertical menu">
                     <li class="o-nav--local__item"><a href="/titleixeo/get-help/policy-procedures/equal-opportunity-laws.php" class="gtm-nav--local">Equal Opportunity Laws</a></li>
                  </ul>
               </li>
            </ul>
         </li>
         <li class="o-nav--local__item"><a href="/titleixeo/resources-guides/index.php" class="gtm-nav--local">Resources &amp; Guides</a><ul class="nested vertical menu">
               <li class="o-nav--local__item"><a href="/titleixeo/resources-guides/resolution-processes/index.php" class="gtm-nav--local">Resolution Processes</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/resources-guides/complainant-support/index.php" class="gtm-nav--local">Complainant Support</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/resources-guides/respondent-support/index.php" class="gtm-nav--local">Respondent Support</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/resources-guides/witness-support/index.php" class="gtm-nav--local">Witness Support</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/resources-guides/lgbtq-support/index.php" class="gtm-nav--local">LGBTQIA+ Support</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/resources-guides/pregnancy-parenting-support/index.php" class="gtm-nav--local">Pregnancy &amp; Parenting Support</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/resources-guides/confidential-resource/index.php" class="gtm-nav--local">Confidential Resources</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/resources-guides/other-resources/index.php" class="gtm-nav--local">Other Resources</a></li>
            </ul>
         </li>
         <li class="o-nav--local__item"><a href="/titleixeo/duty-to-report/index.php" class="gtm-nav--local">Duty to Report</a><ul class="nested vertical menu">
               <li class="o-nav--local__item"><a href="/titleixeo/duty-to-report/tips-for-responding/index.php" class="gtm-nav--local">Tips for Responding</a></li>
            </ul>
         </li>
         <li class="o-nav--local__item"><a href="/titleixeo/about-us/index.php" class="gtm-nav--local">About Us</a><ul class="nested vertical menu">
               <li class="o-nav--local__item"><a href="/titleixeo/about-us/trainings-attended/index.php" class="gtm-nav--local">Trainings Attended</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/about-us/prior-campus-updates/index.php" class="gtm-nav--local">Prior Campus Updates</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/about-us/annual-reports/index.php" class="gtm-nav--local">Annual Reports</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/about-us/external-reviews/index.php" class="gtm-nav--local">External Reviews</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/about-us/department-of-justice/index.php" class="gtm-nav--local">Department of Justice</a></li>
               <li class="o-nav--local__item"><a href="/titleixeo/about-us/cozen-o-connor/index.php" class="gtm-nav--local">Cozen O'Connor</a></li>
            </ul>
         </li>
         <li class="o-nav--local__item"><a href="/titleixeo/make-a-report/index.php" class="gtm-nav--local">Make A Report</a></li>
      </ul>
   </nav>
</div></div>
