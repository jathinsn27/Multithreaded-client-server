            ...
            <main id="sjsu-maincontent" role="main">
               ...
               <div class="o-wrap o-wrap--media-type-hero u-bg--dark ou-error--snippet">
                  <div class="o-media o-media--hero">
                     <div class="o-media__frame">
                        <div class="o-media__graphic"><img class="o-media__img" src="/_images/people/ADV_move-in-day-dschmitz_3.jpg" alt="An SJSU student with her parents moving boxes."></div>
                     </div>
                     <div class="o-media__bg-extender">
                        <div class="o-media__frame"><span class="u-gradientbar"></span><div class="o-media__copy">
                              ...
                              <p class="o-c2a"><a class="o-c2a__link" href="/housing/index.php">Visit University Housing Services</a></p>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="o-wrap o-wrap--media-type2 u-bg--dark ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-media o-media--type2">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="/_images/buildings/ADV_campus-housing_1.jpg" alt=""></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
               ...
               <div class="o-wrap o-wrap--media-type1 u-bg--typeface-pattern-diamonds u-bg--fade-radial ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-media o-media--type1">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="/_images/buildings/ADV_InternationalHouse_jgensheimer_1.jpg" alt="International House is a co-ed residence."></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy u-gradientbar">
                                 <p class="o-media__heading u-bar u-bar--sjsu-gold"><a class="o-media__link" href="/ihouse/">International House</a></p>
               ...
               <div class="o-wrap o-wrap--media-type1 u-bg--typeface-pattern-diamonds u-bg--fade-radial ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-media o-media--type1">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="/_images/people/ADV_move-in-day-dschmitz_1.jpg" alt="Freshman students posing with their parents in the dorm."></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy u-gradientbar">
                                 <p class="o-media__heading u-bar u-bar--sjsu-gold"><a class="o-media__link" href="/sjsucares/get-assistance/index.php">Housing Assistance</a></p>
