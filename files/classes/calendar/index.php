...
<!-- End Google Tag Manager -->	<a id="skiplink" href="#sjsu-maincontent" class="show-for-sr">Skip to main content</a><header id="sjsu-header" class="o-region o-region--header" role="banner">
		<div class="o-wrap--globalnav u-bg--dark">
         ...
         <div class="o-wrap--content ">
            <p id="maintitle" class="o-title o-title--site show-for-large"><a class="o-title--site__link" href="https://www.sjsu.edu/classes/index.php">Class Schedules</a></p><a id="subtitle" class="o-title o-title--parent-org show-for-large" href="https://www.sjsu.edu/provost/index.php">Academic Affairs</a></div>
      </header>
      ...
      <nav id="sitenav-mobile" class="top-bar o-nav--site" data-topbar="data-topbar" role="navigation" aria-label="Site nav menu for small screens">
         <div class="top-bar-title" data-responsive-toggle="sitenav-mobile-menu" data-hide-for="medium">
            <div class="o-nav--site__title">
               <h1><a class="o-title o-title--site-mobile " href="https://www.sjsu.edu/classes/index.php">Class Schedules</a></h1><span class="o-title o-title--parent-org-mobile"><a href="https://www.sjsu.edu/provost/index.php">Academic Affairs</a></span></div>
         ...
         <div id="sitenav-mobile-menu" style="min-width:100%">
            <ul class="vertical menu accordion-menu" data-accordion-menu="data-accordion-menu" data-submenu-toggle="data-submenu-toggle">
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/classes/schedules/index.php">Schedules</a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/index.php">Schedules</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/fall-2024.php">Fall 2024</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/classes/schedules/subject-notes/index.php">Subject Notes</a><ul class="menu">
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/subject-notes/index.php">Subject Notes</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/subject-notes/fall-2024.php">Fall 2024</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/subject-notes/spring-2024.php">Spring 2024</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/classes/schedules/subject-notes/archive/index.php">Archive</a><ul class="menu">
                                 <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/subject-notes/archive/index.php">Archive</a></li>
                                 <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/subject-notes/archive/fall-2023.php">Fall 2023</a></li>
                                 <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/subject-notes/archive/spring-2023.php">Spring 2023</a></li>
                                 <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/subject-notes/archive/fall-2022.php">Fall 2022</a></li>
                                 <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/subject-notes/archive/spring-2022.php">Spring 2022</a></li>
                                 <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/subject-notes/archive/fall-2021.php">Fall 2021</a></li>
                                 <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/subject-notes/archive/spring-2021.php">Spring 2021</a></li>
                                 <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/subject-notes/archive/fall-2020.php">Fall 2020</a></li>
                              </ul>
                           </li>
                        </ul>
                     </li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/classes/schedules/archive/index.php">Archive</a><ul class="menu">
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/index.php">Archive</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/winter-2024.php">Winter 2024</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/fall-2023.php">Fall 2023</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/summer-2023.php">Summer 2023</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/spring-2023.php">Spring 2023</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/winter-2023.php">Winter 2023</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/fall-2022.php">Fall 2022</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/summer-2022.php">Summer 2022</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/spring-2022.php">Spring 2022</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/winter-2022.php">Winter 2022</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/fall-2021.php">Fall 2021</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/summer-2021.php">Summer 2021</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/spring-2021.php">Spring 2021</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/winter-2021.php">Winter 2021</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/fall-2020.php">Fall 2020</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/summer-2020.php">Summer 2020</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/schedules/archive/winter-2020.php">Winter 2020</a></li>
                        </ul>
                     </li>
                  </ul>
               </li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/classes/calendar/index.php">Calendar</a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/calendar/index.php">Calendar</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/calendar/2024-2025.php">2024-2025</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/classes/calendar/archive/index.php">Archive</a><ul class="menu">
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/calendar/archive/index.php">Archive</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/calendar/archive/2023-2024.php">2023-2024</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/calendar/archive/2022-2023.php">2022-2023</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/calendar/archive/2021-2022.php">2021-2022</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/calendar/archive/2020-2021.php">2020-2021</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/calendar/archive/2019-2020.php">2019-2020</a></li>
                        </ul>
                     </li>
                  </ul>
               </li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/classes/final-exam-schedule/index.php">Final Exam Schedule</a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/final-exam-schedule/index.php">Final Exam Schedule</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/final-exam-schedule/spring-2024.php">Spring 2024</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/final-exam-schedule/fall-2024.php">Fall 2024</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/final-exam-schedule/policy.php">Final Exam Policy</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/classes/final-exam-schedule/archive/index.php">Archive</a><ul class="menu">
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/final-exam-schedule/archive/index.php">Archive</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/final-exam-schedule/archive/spring-2023.php">Spring 2023</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/final-exam-schedule/archive/fall-2022.php">Fall 2022</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/final-exam-schedule/archive/fall-2023.php">Fall 2023</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/final-exam-schedule/archive/spring-2022.php">Spring 2022</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/final-exam-schedule/archive/fall-2021.php">Fall 2021</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/final-exam-schedule/archive/spring-2021.php">Spring 2021</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/final-exam-schedule/archive/fall-2020.php">Fall 2020</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/final-exam-schedule/archive/spring-2020.php">Spring 2020</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/final-exam-schedule/archive/fall-2019.php">Fall 2019</a></li>
                        </ul>
                     </li>
                  </ul>
               </li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/classes/register/index.php">Register</a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/register/index.php">Register</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/register/myscheduler.php">MyScheduler</a></li>
                  </ul>
               </li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/symbols-abbreviations.php">Symbols &amp; Abbreviations</a></li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/classes/tuition-fees-payment-refunds.php">Tuition, Fees, Payment, &amp; Refunds</a></li>
            </ul>
         </div>
      </nav>
   </div>
   ...
   <div class="o-wrap--content">
      <nav id="sitenav" class="o-nav--site" role="navigation" aria-label="Site nav menu">
         <ul class="dropdown menu" data-dropdown-menu="data-dropdown-menu">
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/classes/schedules/index.php">Schedules</a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/classes/schedules/fall-2024.php" class="gtm-nav--site">Fall&nbsp;2024</a></li>
                  <li class="o-nav--site__item"><a href="/classes/schedules/subject-notes/index.php" class="gtm-nav--site">Subject&nbsp;Notes</a></li>
                  <li class="o-nav--site__item"><a href="/classes/schedules/archive/index.php" class="gtm-nav--site">Archive</a></li>
               </ul>
            </li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/classes/calendar/index.php">Calendar</a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/classes/calendar/2024-2025.php" class="gtm-nav--site">2024-2025</a></li>
                  <li class="o-nav--site__item"><a href="/classes/calendar/archive/index.php" class="gtm-nav--site">Archive</a></li>
               </ul>
            </li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/classes/final-exam-schedule/index.php">Final Exam Schedule</a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/classes/final-exam-schedule/spring-2024.php" class="gtm-nav--site">Spring&nbsp;2024</a></li>
                  <li class="o-nav--site__item"><a href="/classes/final-exam-schedule/fall-2024.php" class="gtm-nav--site">Fall&nbsp;2024</a></li>
                  <li class="o-nav--site__item"><a href="/classes/final-exam-schedule/policy.php" class="gtm-nav--site">Final&nbsp;Exam&nbsp;Policy</a></li>
                  <li class="o-nav--site__item"><a href="/classes/final-exam-schedule/archive/index.php" class="gtm-nav--site">Archive</a></li>
               </ul>
            </li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/classes/register/index.php">Register</a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/classes/register/myscheduler.php" class="gtm-nav--site">MyScheduler</a></li>
               </ul>
            </li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/classes/symbols-abbreviations.php">Symbols&nbsp;&amp;&nbsp;Abbreviations</a></li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/classes/tuition-fees-payment-refunds.php">Tuition,&nbsp;Fees,&nbsp;Payment,&nbsp;&amp;&nbsp;Refunds</a></li>
         </ul>
      </nav>
   </div>
            ...
            <main id="sjsu-maincontent" role="main">
               ...
               <header>
                  ...
                  <section>
                     ...
                     <p><a href="/classes/calendar/2024-2025.php">2024-2025 Academic Year Calendar</a><br><a style="font-size: 1rem; letter-spacing: 0px; background-color: #ffffff;" href="/classes/calendar/archive/index.php">Archive</a></p>
                     
                     <p>Printable Academic Year Calendars, including past calendars, are available at <a href="/provost/resources/academic-calendars/index.php">Office of the Provost's site</a>.</p>
                     </section>
                  </header>
   ...
   <nav id="sjsu-localnav" class="o-nav--local hide-for-small-only" role="navigation" aria-label="Local nav menu">
      <ul class="vertical menu">
         <li class="o-nav--local__item"><a href="/classes/schedules/index.php" class="gtm-nav--local">Schedules</a><ul class="nested vertical menu">
               <li class="o-nav--local__item"><a href="/classes/schedules/fall-2024.php" class="gtm-nav--local">Fall 2024</a></li>
               <li class="o-nav--local__item"><a href="/classes/schedules/subject-notes/index.php" class="gtm-nav--local">Subject Notes</a><ul class="nested vertical menu">
                     <li class="o-nav--local__item"><a href="/classes/schedules/subject-notes/fall-2024.php" class="gtm-nav--local">Fall 2024</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/subject-notes/spring-2024.php" class="gtm-nav--local">Spring 2024</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/subject-notes/archive/index.php" class="gtm-nav--local">Archive</a><ul class="nested vertical menu">
                           <li class="o-nav--local__item"><a href="/classes/schedules/subject-notes/archive/fall-2023.php" class="gtm-nav--local">Fall 2023</a></li>
                           <li class="o-nav--local__item"><a href="/classes/schedules/subject-notes/archive/spring-2023.php" class="gtm-nav--local">Spring 2023</a></li>
                           <li class="o-nav--local__item"><a href="/classes/schedules/subject-notes/archive/fall-2022.php" class="gtm-nav--local">Fall 2022</a></li>
                           <li class="o-nav--local__item"><a href="/classes/schedules/subject-notes/archive/spring-2022.php" class="gtm-nav--local">Spring 2022</a></li>
                           <li class="o-nav--local__item"><a href="/classes/schedules/subject-notes/archive/fall-2021.php" class="gtm-nav--local">Fall 2021</a></li>
                           <li class="o-nav--local__item"><a href="/classes/schedules/subject-notes/archive/spring-2021.php" class="gtm-nav--local">Spring 2021</a></li>
                           <li class="o-nav--local__item"><a href="/classes/schedules/subject-notes/archive/fall-2020.php" class="gtm-nav--local">Fall 2020</a></li>
                        </ul>
                     </li>
                  </ul>
               </li>
               <li class="o-nav--local__item"><a href="/classes/schedules/archive/index.php" class="gtm-nav--local">Archive</a><ul class="nested vertical menu">
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/winter-2024.php" class="gtm-nav--local">Winter 2024</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/fall-2023.php" class="gtm-nav--local">Fall 2023</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/summer-2023.php" class="gtm-nav--local">Summer 2023</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/spring-2023.php" class="gtm-nav--local">Spring 2023</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/winter-2023.php" class="gtm-nav--local">Winter 2023</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/fall-2022.php" class="gtm-nav--local">Fall 2022</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/summer-2022.php" class="gtm-nav--local">Summer 2022</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/spring-2022.php" class="gtm-nav--local">Spring 2022</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/winter-2022.php" class="gtm-nav--local">Winter 2022</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/fall-2021.php" class="gtm-nav--local">Fall 2021</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/summer-2021.php" class="gtm-nav--local">Summer 2021</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/spring-2021.php" class="gtm-nav--local">Spring 2021</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/winter-2021.php" class="gtm-nav--local">Winter 2021</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/fall-2020.php" class="gtm-nav--local">Fall 2020</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/summer-2020.php" class="gtm-nav--local">Summer 2020</a></li>
                     <li class="o-nav--local__item"><a href="/classes/schedules/archive/winter-2020.php" class="gtm-nav--local">Winter 2020</a></li>
                  </ul>
               </li>
            </ul>
         </li>
         <li class="o-nav--local__item"><a href="/classes/calendar/index.php" class="gtm-nav--local">Calendar</a><ul class="nested vertical menu">
               <li class="o-nav--local__item"><a href="/classes/calendar/2024-2025.php" class="gtm-nav--local">2024-2025</a></li>
               <li class="o-nav--local__item"><a href="/classes/calendar/archive/index.php" class="gtm-nav--local">Archive</a><ul class="nested vertical menu">
                     <li class="o-nav--local__item"><a href="/classes/calendar/archive/2023-2024.php" class="gtm-nav--local">2023-2024</a></li>
                     <li class="o-nav--local__item"><a href="/classes/calendar/archive/2022-2023.php" class="gtm-nav--local">2022-2023</a></li>
                     <li class="o-nav--local__item"><a href="/classes/calendar/archive/2021-2022.php" class="gtm-nav--local">2021-2022</a></li>
                     <li class="o-nav--local__item"><a href="/classes/calendar/archive/2020-2021.php" class="gtm-nav--local">2020-2021</a></li>
                     <li class="o-nav--local__item"><a href="/classes/calendar/archive/2019-2020.php" class="gtm-nav--local">2019-2020</a></li>
                  </ul>
               </li>
            </ul>
         </li>
         <li class="o-nav--local__item"><a href="/classes/final-exam-schedule/index.php" class="gtm-nav--local">Final Exam Schedule</a><ul class="nested vertical menu">
               <li class="o-nav--local__item"><a href="/classes/final-exam-schedule/spring-2024.php" class="gtm-nav--local">Spring 2024</a></li>
               <li class="o-nav--local__item"><a href="/classes/final-exam-schedule/fall-2024.php" class="gtm-nav--local">Fall 2024</a></li>
               <li class="o-nav--local__item"><a href="/classes/final-exam-schedule/policy.php" class="gtm-nav--local">Final Exam Policy</a></li>
               <li class="o-nav--local__item"><a href="/classes/final-exam-schedule/archive/index.php" class="gtm-nav--local">Archive</a><ul class="nested vertical menu">
                     <li class="o-nav--local__item"><a href="/classes/final-exam-schedule/archive/spring-2023.php" class="gtm-nav--local">Spring 2023</a></li>
                     <li class="o-nav--local__item"><a href="/classes/final-exam-schedule/archive/fall-2022.php" class="gtm-nav--local">Fall 2022</a></li>
                     <li class="o-nav--local__item"><a href="/classes/final-exam-schedule/archive/fall-2023.php" class="gtm-nav--local">Fall 2023</a></li>
                     <li class="o-nav--local__item"><a href="/classes/final-exam-schedule/archive/spring-2022.php" class="gtm-nav--local">Spring 2022</a></li>
                     <li class="o-nav--local__item"><a href="/classes/final-exam-schedule/archive/fall-2021.php" class="gtm-nav--local">Fall 2021</a></li>
                     <li class="o-nav--local__item"><a href="/classes/final-exam-schedule/archive/spring-2021.php" class="gtm-nav--local">Spring 2021</a></li>
                     <li class="o-nav--local__item"><a href="/classes/final-exam-schedule/archive/fall-2020.php" class="gtm-nav--local">Fall 2020</a></li>
                     <li class="o-nav--local__item"><a href="/classes/final-exam-schedule/archive/spring-2020.php" class="gtm-nav--local">Spring 2020</a></li>
                     <li class="o-nav--local__item"><a href="/classes/final-exam-schedule/archive/fall-2019.php" class="gtm-nav--local">Fall 2019</a></li>
                  </ul>
               </li>
            </ul>
         </li>
         <li class="o-nav--local__item"><a href="/classes/register/index.php" class="gtm-nav--local">Register</a><ul class="nested vertical menu">
               <li class="o-nav--local__item"><a href="/classes/register/myscheduler.php" class="gtm-nav--local">MyScheduler</a></li>
            </ul>
         </li>
         <li class="o-nav--local__item"><a href="/classes/symbols-abbreviations.php" class="gtm-nav--local">Symbols &amp; Abbreviations</a></li>
         <li class="o-nav--local__item"><a href="/classes/tuition-fees-payment-refunds.php" class="gtm-nav--local">Tuition, Fees, Payment, &amp; Refunds</a></li>
      </ul>
   </nav>
</div></div>
   ...
   <div class="o-region--contact__block">
      <div class="o-region--contact__item u-icon--big u-icon--phone u-color--sjsu-gray">
         ...
         <div class="o-region--contact__detail">
            ...
            <p>Contact the <a href="/admissions/">Admissions Office</a>.</p>
            <h4>Current Students</h4>
            <p>Contact <a href="/academics/colleges-and-departments.php">departments and colleges</a>.</p>
            <p>Tuition, fees, payment, or refund questions? Contact the <a href="/bursar/">Bursar's Office</a>.</p>
            <h4>Academic College or Department Staff/Faculty</h4>
            <p>Contact the <a href="/academicscheduling/">Academic Scheduling and Space Management Department</a>.&nbsp;</p>
         </div>
      </div>
   </div>
</aside>
