...
<link rel="stylesheet" href="../aspis/css/prototype.css"/><script type="text/javascript">
			var page_url="https://www.sjsu.edu/about/doing-business-with-sjsu.php";
		</script><title>Doing Business with SJSU | About</title>
      <meta name="Description" content="SJSU Contracts and Purchasing Services is responsible for selecting the best source of goods and services for the university in compliance with a wide variety of accessibility, ethics, fair practices and other policies."><script>
...
<!-- End Google Tag Manager -->	<a id="skiplink" href="doing-business-with-sjsu.php#sjsu-maincontent" class="show-for-sr">Skip to main content</a><header id="sjsu-header" class="o-region o-region--header" role="banner">
            ...
            <div class="o-wrap--content">
               <nav role="navigation" id="breadcrumb" class="o-nav--breadcrumb clearfix" aria-label="breadcrumb">
                  <ol class="o-nav--breadcrumb__menu"><!--Text value is blank-->
                     ...
                     <li class="o-nav--breadcrumb__item"><a aria-current="page">Doing Business with SJSU</a></li>
                  </ol>
               </nav>
            </div>
         </div>
      ...
      <div class="o-region o-region--maincontent">
         <div class="o-region--maincontent__main">
            <main id="sjsu-maincontent" role="main">
               <h1 class="o-title--landing">Doing Business with SJSU</h1>
               <div class="o-wrap o-wrap--media-type-hero u-bg--dark ou-error--snippet">
                  <div class="o-media o-media--hero">
                     <div class="o-media__frame">
                        <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/people/NorthGarageInstallation-jlepe-060619_0027-hero.jpg" alt="North Garage installation."></div>
                     </div>
                     <div class="o-media__bg-extender">
                        <div class="o-media__frame"><span class="u-gradientbar"></span><div class="o-media__copy">
                              <p class="o-media__heading">Supporting the SJSU Community</p>
                              <p class="o-media__text">SJSU Contracts and Procurement Services is responsible for selecting the best source
                                 of goods and services for the university in compliance with a wide variety of accessibility,
                                 ethics, fair practices and other policies.&nbsp;</p>
                              <p class="o-c2a"><a class="o-c2a__link" href="https://www.sjsu.edu/fabs/services/suppliers/index.php">Want to do business with SJSU?</a></p>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="o-wrap o-wrap--media-type1 u-bg--typeface-pattern-diamonds u-bg--fade-radial ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-media o-media--type1">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/buildings/ADV_spring-semester-welcome--dschmitz-012419-6529.jpg" alt="Construction site of the SRAC."></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy u-gradientbar">
                                 <p class="o-media__heading u-bar u-bar--sjsu-gold">Modernizing Campus Facilities</p>
                                 <p class="o-media__text">New facilities are and will continue to be needed to meet the&nbsp;ongoing teaching and
                                    research needs of the university. Your support&nbsp;enhances the aesthetics, functionality,
                                    ...
                                    campus spaces.&nbsp;</p>
                                 <p class="o-c2a"><a class="o-c2a__link" href="https://www.sjsu.edu/fdo/departments/pdc/">Learn about Planning, Design and Construction</a></p>
                              </div>
                           </div>
                        </div>
                     </div>
...
<!-- /Slate Ping Analytics -->      <div id="hidden" style="display:none;"><a href="https://a.cms.omniupdate.com/11/?skin=sjsu&amp;account=sjsu&amp;site=www&amp;action=de&amp;path=/about/doing-business-with-sjsu.pcf" target="_top" rel="nofollow" id="de">Last Updated Aug 23, 2022</a></div>
   </body>
</html>