...
<link rel="stylesheet" href="../aspis/css/prototype.css"/><script type="text/javascript">
			var page_url="https://www.sjsu.edu/campus-life/sac.php";
		</script><title>Student Alumni Connection | Campus Life</title>
      <meta name="Description" content="SJSU Student Alumni Connection links you directly with some 200,000 professional Spartans worldwide, offering networking and career events, scholarships, social activities, mentorships and leadership opportunities. "><script>
...
<!-- End Google Tag Manager -->	<a id="skiplink" href="sac.php#sjsu-maincontent" class="show-for-sr">Skip to main content</a><header id="sjsu-header" class="o-region o-region--header" role="banner">
            ...
            <div class="o-wrap--content">
               <nav role="navigation" id="breadcrumb" class="o-nav--breadcrumb clearfix" aria-label="breadcrumb">
                  <ol class="o-nav--breadcrumb__menu"><!--Text value is blank-->
                     ...
                     <li class="o-nav--breadcrumb__item"><a aria-current="page">Student Alumni Connection</a></li>
                  </ol>
               </nav>
            </div>
         </div>
      ...
      <div class="o-region o-region--maincontent">
         <div class="o-region--maincontent__main">
            <main id="sjsu-maincontent" role="main">
               <h1 class="o-title--landing">Student Alumni Connection</h1>
               <div class="o-wrap o-wrap--media-type-hero u-bg--dark ou-error--snippet">
                  <div class="o-media o-media--hero">
                     <div class="o-media__frame">
                        <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/people/ADV_graduates-alumni_01.jpg" alt="SJSU graduates in cap and gowns embracing."></div>
                     </div>
                     <div class="o-media__bg-extender">
                        <div class="o-media__frame"><span class="u-gradientbar"></span><div class="o-media__copy">
                              <p class="o-media__heading">Student Alumni Connection</p>
                              <p class="o-media__text">Whether you're just beginning your college experience, or you're nearing the finish
                                 ...
                                 and career events, social activities, and leadership opportunities.</p>
                              <p class="o-c2a"><a class="o-c2a__link" href="https://www.sjsu.edu/alumni/resources/student-alumni-connection.php">Connect with Us to Begin Your Journey</a></p>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="o-wrap o-wrap--media-postcard u-bg--dark ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-media o-media--postcard">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/people/ADV_alumni_scholarships_jt_2.jpg" alt="A staff member shakes the hand of a scholarship recipient. "></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy">
                                 <p class="o-media__heading"><a class="o-media__link" href="https://www.sjsu.edu/alumni/get-involved/scholarships.php">Scholarship Programs</a></p>
                                 <p class="o-media__text">Our programs&nbsp;annually award&nbsp;more than&nbsp;$180,000 in scholarships to both undergraduate
...
<!-- /Slate Ping Analytics -->      <div id="hidden" style="display:none;"><a href="https://a.cms.omniupdate.com/11/?skin=sjsu&amp;account=sjsu&amp;site=www&amp;action=de&amp;path=/campus-life/sac.pcf" target="_top" rel="nofollow" id="de">Last Updated Mar 6, 2024</a></div>
   </body>
</html>