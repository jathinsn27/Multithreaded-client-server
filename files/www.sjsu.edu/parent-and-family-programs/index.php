...
<link rel="stylesheet" href="../aspis/css/prototype.css"/><script type="text/javascript">
			var page_url="http://www.sjsu.edu/parent-and-family-programs/index.php";
		</script><title>Parent and Family Programs</title>
      <meta name="Description" content="Welcome to the Spartan family! Sign up for monthly updates, find tips to support your student and sign up for orientation. "><script>
					var currentNavigationStart = "/parent-and-family-programs/";
				</script></head>
										...
										<ul class="amm-o-nav__menu">
											...
											<li class="amm-o-nav__group">
												...
												<ul class="amm-o-nav__list">
													...
													<li class="amm-o-nav__item"><a href="index.php">Parent and <br />Family Programs</a></li>
                                                </ul>
											</li>
											<li class="amm-o-nav__group">
							...
							<ul class="vertical menu accordion-menu" data-accordion-menu="data-accordion-menu" data-submenu-toggle="data-submenu-toggle">
								...
								<li class="o-nav--global__item">
									...
									<ul class="menu vertical">
										...
										<li class="o-nav--global__item o-nav--global__item--nested"><a href="index.php">Parents and Family Programs</a></li>
									</ul>    
								</li>
								<li class="o-nav--global__item">
            ...
            <div class="o-wrap--content">
               <nav role="navigation" id="breadcrumb" class="o-nav--breadcrumb clearfix" aria-label="breadcrumb">
                  <ol class="o-nav--breadcrumb__menu">
                     ...
                     <li class="o-nav--breadcrumb__item"><a aria-current="page">Parent and Family Programs</a></li>
                  </ol>
               </nav>
            </div>
         </div>
         <div class="o-wrap--content show-for-sr">
            <h1 id="maintitle" class="o-title o-title--site show-for-large"><a class="o-title--site__link" href="http://www.sjsu.edu/parent-and-family-programs/index.php">Parent and Family Programs</a></h1><span class="show-for-large">&nbsp;</span></div>
      </header>
      <div class="o-region o-region--maincontent">
         <div class="o-region--maincontent__main">
            <main id="maincontent" role="main">
               <h1 class="o-title--landing">Parent and Family Programs</h1>
               <div class="o-wrap o-wrap--media-type-hero o-wrap--flex-component--DISABLE u-bg--dark ou-error--snippet">
                  <div class="o-media o-media--hero">
                     <div class="o-media__frame">
                        <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/people/ADV_parent-and-family-programs_2.jpg" alt="Parent and Family Programs"></div>
                     </div>
                     <div class="o-media__bg-extender">
                        <div class="o-media__frame"><span class="u-gradientbar"></span><div class="o-media__copy">
                              <p class="o-media__heading"><a class="o-media__link" href="https://www.sjsu.edu/newspartans/">Parent and Family Programs</a></p>
                              <p class="o-media__text">Parents and families, welcome to the Spartan family! Congratulations on your student’s
                                 enrollment in San Jose State. Your role in your student’s life now is as important
               ...
               <div class="o-wrap o-wrap--cardholder o-wrap--grid-component--DISABLE u-bg--triangles-down-small u-color--paseo-gray u-bg--fade-radial ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-cardholder u-gridgap-half">
                        <div class="o-card"><img class="o-card__img" src="https://www.sjsu.edu/_images/people/ADV_join-our-newsletter_1.jpg" alt="Join Our Newsletter"><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="https://sjsu.campusesp.com/users/sign_in">Parent and Family Portal</a></p>
                              
                              <p class="o-card__copy">Sign up through the Parent and Family Portal to stay connected and get campus news
                                 and information.
                              </p>
                              
                           </div>
                        </div>
                        <div class="o-card"><img class="o-card__img" src="https://www.sjsu.edu/_images/people/ADV_tips-for-parents-families_1.jpg" alt="Tips for Parents and Families"><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="http://www.sjsu.edu/newspartans/parents-and-families/parent-family-portal/index.html">Tips for Parents and Families</a></p>
                              
                              <p class="o-card__copy">See orientation and first semester tips to help support your student.</p>
                              
                           </div>
                        </div>
                        <div class="o-card"><img class="o-card__img" src="https://www.sjsu.edu/_images/people/ADV_family-advisory-board_1.jpg" alt="Family Advisory Board"><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="http://www.sjsu.edu/newspartans/parents-and-families/family-advisory-board/index.html">Family Advisory Board</a></p>
                              
                              <p class="o-card__copy">We&nbsp;provide advice on matters of importance to students and parents and supporters
                                 of SJSU.
                              </p>
               ...
               <div class="o-wrap o-wrap--media-type2 o-wrap--flex-component--DISABLE u-bg--dark ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-media o-media--type2">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/people/ADV_admitted-spartan-day-dschmitz_1.jpg" alt=""></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy">
                                 <p class="o-media__heading"><a class="o-media__link" href="http://www.sjsu.edu/newspartans/parents-and-families/orientation/index.html">Parent and Family Freshman Orientation</a></p>
                                 <p class="o-media__text">Join us during Frosh Orientation to learn more about SJSU and how you can play a supportive
...
<!-- /Slate Ping Analytics -->      <div id="hidden" style="display:none;">
         <a href="https://a.cms.omniupdate.com/10?skin=sjsu&amp;account=sjsu&amp;site=www&amp;action=de&amp;path=/parent-and-family-programs/index.pcf" target="_top" rel="nofollow" id="de">Last Updated Mar 10, 2020</a>
      </div>
   </body>
</html>