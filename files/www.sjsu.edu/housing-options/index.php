...
<link rel="stylesheet" href="../aspis/css/prototype.css"/><script type="text/javascript">
			var page_url="https://www.sjsu.edu/housing-options/index.php";
		</script><title>Housing</title><script>
					var currentNavigationStart = "/housing-options/";
				</script></head>
										...
										<ul class="amm-o-nav__menu">
											...
											<li class="amm-o-nav__group">
												...
												<ul class="amm-o-nav__list">
													...
													<li class="amm-o-nav__item"><a href="index.php">Housing</a></li>
            ...
            <div class="o-wrap--content">
               <nav role="navigation" id="breadcrumb" class="o-nav--breadcrumb clearfix" aria-label="breadcrumb">
                  <ol class="o-nav--breadcrumb__menu">
                     ...
                     <li class="o-nav--breadcrumb__item"><a aria-current="page">Housing</a></li>
                  </ol>
               </nav>
            </div>
         </div>
         <div class="o-wrap--content show-for-sr">
            <p id="maintitle" class="o-title o-title--site show-for-large"><a class="o-title--site__link" href="http://www.sjsu.edu/housing-options/index.php">Housing</a></p><span class="show-for-large">&nbsp;</span></div>
      </header>
      <div class="o-region o-region--maincontent">
         <div class="o-region--maincontent__main">
            <main id="sjsu-maincontent" role="main">
               <h1 class="o-title--landing">Housing</h1>
               <div class="o-wrap o-wrap--media-type-hero u-bg--dark ou-error--snippet">
                  <div class="o-media o-media--hero">
                     <div class="o-media__frame">
                        <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/people/ADV_move-in-day-dschmitz_3.jpg" alt="An SJSU student with her parents moving boxes."></div>
                     </div>
                     <div class="o-media__bg-extender">
                        <div class="o-media__frame"><span class="u-gradientbar"></span><div class="o-media__copy">
                              <p class="o-media__heading">Your&nbsp;SJSU Home</p>
                              <p class="o-media__text">Where you live as a student has a big impact on your educational experience. SJSU
                              ...
                              <p class="o-c2a"><a class="o-c2a__link" href="https://www.sjsu.edu/housing/index.php">Visit University Housing Services</a></p>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="o-wrap o-wrap--media-type2 u-bg--dark ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-media o-media--type2">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/buildings/ADV_campus-housing_1.jpg" alt=""></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy">
                                 <p class="o-media__heading">On-Campus Rates</p>
                                 <p class="o-media__text">On-campus housing begins at $7,379 annually. Rates include basic utilities (gas/electricity,
               ...
               <div class="o-wrap o-wrap--media-type1 u-bg--typeface-pattern-diamonds u-bg--fade-radial ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-media o-media--type1">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/buildings/ADV_InternationalHouse_jgensheimer_1.jpg" alt="International House is a co-ed residence."></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy u-gradientbar">
                                 <p class="o-media__heading u-bar u-bar--sjsu-gold"><a class="o-media__link" href="https://www.sjsu.edu/ihouse/">International House</a></p>
                                 <p class="o-media__text">International House is a co-ed residence for 70 U.S. and international students attending
               ...
               <div class="o-wrap o-wrap--media-type1 u-bg--typeface-pattern-diamonds u-bg--fade-radial ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-media o-media--type1">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/people/ADV_move-in-day-dschmitz_1.jpg" alt="Freshman students posing with their parents in the dorm."></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy u-gradientbar">
                                 <p class="o-media__heading u-bar u-bar--sjsu-gold"><a class="o-media__link" href="https://www.sjsu.edu/sjsucares/get-assistance/index.php">Housing Assistance</a></p>
                                 <p class="o-media__text">If you're a current SJSU student who has had a recent crisis&nbsp;that has left you food
...
<!-- /Slate Ping Analytics -->      <div id="hidden" style="display:none;">
         <a href="https://a.cms.omniupdate.com/11/?skin=sjsu&amp;account=sjsu&amp;site=www&amp;action=de&amp;path=/housing-options/index.pcf" target="_top" rel="nofollow" id="de">Last Updated Jul 22, 2021</a>
      </div>
   </body>
</html>