...
<link rel="stylesheet" href="../../aspis/css/prototype.css"/><script type="text/javascript">
			var page_url="https://www.sjsu.edu/about/research/become-a-research-partner.php";
		</script><title>Become a Research Partner | About</title><script>
...
<!-- End Google Tag Manager -->	<a id="skiplink" href="become-a-research-partner.php#sjsu-maincontent" class="show-for-sr">Skip to main content</a><header id="sjsu-header" class="o-region o-region--header" role="banner">
            ...
            <div class="o-wrap--content">
               <nav role="navigation" id="breadcrumb" class="o-nav--breadcrumb clearfix" aria-label="breadcrumb">
                  <ol class="o-nav--breadcrumb__menu">
                     ...
                     <li class="o-nav--breadcrumb__item"><a aria-current="page">Become a Research Partner</a></li>
                  </ol>
               </nav>
            </div>
         </div>
      ...
      <div class="o-region o-region--maincontent">
         <div class="o-region--maincontent__main">
            <main id="sjsu-maincontent" role="main">
               <h1 class="o-title--landing">Become a Research Partner</h1>
               <div class="o-wrap o-wrap--media-type-hero u-bg--dark ou-error--snippet">
                  <div class="o-media o-media--hero">
                     <div class="o-media__frame">
                        <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/people/ADV_robotic-design-projects-dschmitz-051316-247.jpg" alt="SJSU students with professor Winncy Du, Mechanical Engineering."></div>
                     </div>
                     <div class="o-media__bg-extender">
                        <div class="o-media__frame"><span class="u-gradientbar"></span><div class="o-media__copy">
                              <p class="o-media__heading">Silicon Valley's Top Provider of Talent</p>
                              <p class="o-media__text">Each year, SJSU sends&nbsp;more than 8,900 graduates into one of the most innovative ecosystems
               ...
               <div class="o-wrap o-wrap--media-type3 u-bg--dark ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-media o-media--type3">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/people/ADV_research-dschmitz-1.jpg" alt="Research Foundation"></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy">
                                 ...
                                 <p class="o-media__text">The SJSU Research Foundation serves the university by providing a robust research
                                    infrastructure, overseeing 410+ active grants and contracts. Setting up a new venture?
                                    Consider&nbsp;partnering with SJSU faculty members and students.&nbsp;
                                 </p>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="o-media o-media--type3">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/people/ADV_keckfoundation-jgensheimer_1.jpg" alt="Contributing to the Community"></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy">
                                 <p class="o-media__heading"><a class="o-media__link" href="https://www.sjsu.edu/research/about-us/index.html">Office of Research</a></p>
                                 <p class="o-media__text">The Office of Research works with the campus to seek internal and external support
                     ...
                     <div class="o-media o-media--type3">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/people/ADV_tech-ed-commendation_01.jpg" alt="TechEd Commendation"></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy">
                                 <p class="o-media__heading"><a class="o-media__link" href="https://www.sjsu.edu/cgs/">College of Graduate Studies</a></p>
                                 <p class="o-media__text">Created in January 2019, the College of Graduate Studies supports the development
               ...
               <div class="o-wrap o-wrap--media-type1 u-bg--typeface-pattern-diamonds u-bg--fade-radial ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-media o-media--type1">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="https://www.sjsu.edu/_images/people/ADV_sv-wie-conference-dschmitz-031718-8474.jpg" alt="SJSU's Women in Engineering Conference. "></div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
                              <div class="o-media__copy u-gradientbar">
                                 <p class="o-media__heading u-bar u-bar--sjsu-gold">Corporate and Foundation Partnerships</p>
                                 <p class="o-media__text">San Jose State has strong partnerships with leading corporations and foundations in
                                 ...
                                 <p class="o-c2a"><a class="o-c2a__link" href="mailto: officeofresearch@sjsu.edu">Explore Opportunities to Partner with SJSU</a></p>
                              </div>
                           </div>
                        </div>
                     </div>
...
<!-- /Slate Ping Analytics -->      <div id="hidden" style="display:none;">
         <a href="https://a.cms.omniupdate.com/11/?skin=sjsu&amp;account=sjsu&amp;site=www&amp;action=de&amp;path=/about/research/become-a-research-partner.pcf" target="_top" rel="nofollow" id="de">Last Updated Aug 16, 2021</a>
      </div>
   </body>
</html>