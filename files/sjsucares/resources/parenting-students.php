...
<!-- End Google Tag Manager -->	<a id="skiplink" href="#sjsu-maincontent" class="show-for-sr">Skip to main content</a><header id="sjsu-header" class="o-region o-region--header" role="banner">
            ...
            <div class="o-wrap--content">
               <nav role="navigation" id="breadcrumb" class="o-nav--breadcrumb clearfix" aria-label="breadcrumb">
                  <ol class="o-nav--breadcrumb__menu"><!--Text value is blank-->
                     ...
                     <li class="o-nav--breadcrumb__item"><a href="https://www.sjsu.edu/sjsucares/">SJSU Cares</a></li>
   ...
   <div class="o-wrap--content">
      <nav id="sitenav-mobile" class="top-bar o-nav--site" data-topbar="data-topbar" role="navigation" aria-label="Site nav menu for small screens">
         ...
         <div id="sitenav-mobile-menu" style="min-width:100%">
            <ul class="vertical menu accordion-menu" data-accordion-menu="data-accordion-menu" data-submenu-toggle="data-submenu-toggle">
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/sjsucares/get-assistance/index.php">Get Assistance </a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/get-assistance/index.php">Get Assistance </a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/get-assistance/case-management.php">Case Management</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/get-assistance/spartan-food-pantry.php">Spartan Food Pantry</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/get-assistance/calfresh.php">CalFresh Food</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/get-assistance/housing.php">Housing Assistance</a></li>
                  </ul>
               </li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/sjsucares/resources/index.php">Resources </a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/resources/index.php">Resources </a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/resources/igrad.php">iGrad</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/resources/parenting-students.php">Parenting Students</a></li>
                  </ul>
               </li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/sjsucares/give-assistance/index.php">Give Assistance </a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/give-assistance/index.php">Give Assistance </a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/give-assistance/pantry-donation-guide.php">Pantry Donation Guide</a></li>
                  </ul>
               </li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/sjsucares/about/index.php">About</a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/about/index.php">About</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/about/what-we-do.php">What We Do </a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/about/contact-us.php">Contact Us</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/about/data.php">Data and Reports</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/about/presentations.php">Request a Presentation</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/about/faq.php">FAQ</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/sjsucares/about/meet-our-director.php">Meet Our Director</a></li>
                  </ul>
               </li>
            </ul>
         </div>
   ...
   <div class="o-wrap--content">
      <nav id="sitenav" class="o-nav--site" role="navigation" aria-label="Site nav menu">
         <ul class="dropdown menu" data-dropdown-menu="data-dropdown-menu">
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/sjsucares/get-assistance/index.php">Get Assistance </a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/sjsucares/get-assistance/case-management.php" class="gtm-nav--site">Case&nbsp;Management</a></li>
                  <li class="o-nav--site__item"><a href="/sjsucares/get-assistance/spartan-food-pantry.php" class="gtm-nav--site">Spartan&nbsp;Food&nbsp;Pantry</a></li>
                  <li class="o-nav--site__item"><a href="/sjsucares/get-assistance/calfresh.php" class="gtm-nav--site">CalFresh&nbsp;Food</a></li>
                  <li class="o-nav--site__item"><a href="/sjsucares/get-assistance/housing.php" class="gtm-nav--site">Housing&nbsp;Assistance</a></li>
               </ul>
            </li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/sjsucares/resources/index.php">Resources </a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/sjsucares/resources/igrad.php" class="gtm-nav--site">iGrad</a></li>
                  <li class="o-nav--site__item"><a href="/sjsucares/resources/parenting-students.php" class="gtm-nav--site">Parenting&nbsp;Students</a></li>
               </ul>
            </li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/sjsucares/give-assistance/index.php">Give Assistance </a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/sjsucares/give-assistance/pantry-donation-guide.php" class="gtm-nav--site">Pantry&nbsp;Donation&nbsp;Guide</a></li>
               </ul>
            </li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/sjsucares/about/index.php">About</a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/sjsucares/about/what-we-do.php" class="gtm-nav--site">What&nbsp;We&nbsp;Do&nbsp;</a></li>
                  <li class="o-nav--site__item"><a href="/sjsucares/about/contact-us.php" class="gtm-nav--site">Contact&nbsp;Us</a></li>
                  <li class="o-nav--site__item"><a href="/sjsucares/about/data.php" class="gtm-nav--site">Data&nbsp;and&nbsp;Reports</a></li>
                  <li class="o-nav--site__item"><a href="/sjsucares/about/presentations.php" class="gtm-nav--site">Request&nbsp;a&nbsp;Presentation</a></li>
                  <li class="o-nav--site__item"><a href="/sjsucares/about/faq.php" class="gtm-nav--site">FAQ</a></li>
                  <li class="o-nav--site__item"><a href="/sjsucares/about/meet-our-director.php" class="gtm-nav--site">Meet&nbsp;Our&nbsp;Director</a></li>
               </ul>
            </li>
         </ul>
      </nav>
         ...
         <div class="o-region--maincontent__main">
            <main id="sjsu-maincontent" role="main">
               ...
               <p><img src="/sjsucares/pics/children%20playing.jpg" alt="children playing"></p>
               
               <h2>Priority Registration</h2>
               
               <p>Students who identify as parents in their CSU application will be able to register
                  early on all CSU campuses starting in the Fall 2024 registration period. SJSU’s <a href="/registrar/">Office of the Registrar</a> will provide updates on this process as they become available.</p>
               ...
               <p>Basic needs support, including financial, food, housing, clothing, and technology
                  assistance, is available to all SJSU students on the <a href="/sjsucares/get-assistance/index.php">SJSU Cares Get Assistance page</a>. Pregnant and parenting students may qualify for additional on- and off-campus assistance.</p>
               
               <hr>
               
               <h2>On-Campus Childcare</h2>
               
               <p>The <a href="/as/departments/child-development-center/index.php">Child Development Center</a> offers on-campus childcare that is licensed by the California Department of Social
               ...
               <p>The <a href="/titleix/">Title IX and Gender Equity Office</a> ensures that students and employees are protected from discrimination based on pregnancy
                  and pregnancy-related conditions. The <a href="/titleix/help/report/index.php">Report an Incident page</a> provides a path to report any kind of gender based discrimination or harassment,
                  including pregnancy-related discrimination.</p>
               
               <p>The <a href="/titleix/policies-procedures-and-training/notice-of-nondiscrimination/index.php">SJSU’s Notice of Nondiscrimination page</a> further details the protections SJSU provides against discrimination relating to
                  pregnancy and/or parenting.</p>
               
               <p>The <a href="/titleix/help/pregnancy-and-parenting-support/index.php">Pregnancy and Parenting Support page</a> contains information on temporary medical leaves, lactation rooms, and other support.</p>
            </main>
         </div>
   ...
   <nav id="sjsu-localnav" class="o-nav--local hide-for-small-only" role="navigation" aria-label="Local nav menu">
      <ul class="vertical menu">
         <li class="o-nav--local__item"><a href="/sjsucares/get-assistance/index.php" class="gtm-nav--local">Get Assistance </a><ul class="nested vertical menu">
               <li class="o-nav--local__item"><a href="/sjsucares/get-assistance/case-management.php" class="gtm-nav--local">Case Management</a></li>
               <li class="o-nav--local__item"><a href="/sjsucares/get-assistance/spartan-food-pantry.php" class="gtm-nav--local">Spartan Food Pantry</a></li>
               <li class="o-nav--local__item"><a href="/sjsucares/get-assistance/calfresh.php" class="gtm-nav--local">CalFresh Food</a></li>
               <li class="o-nav--local__item"><a href="/sjsucares/get-assistance/housing.php" class="gtm-nav--local">Housing Assistance</a></li>
            </ul>
         </li>
         <li class="o-nav--local__item"><a href="/sjsucares/resources/index.php" class="gtm-nav--local">Resources </a><ul class="nested vertical menu">
               <li class="o-nav--local__item"><a href="/sjsucares/resources/igrad.php" class="gtm-nav--local">iGrad</a></li>
               <li class="o-nav--local__item"><a href="/sjsucares/resources/parenting-students.php" class="gtm-nav--local">Parenting Students</a></li>
            </ul>
         </li>
         <li class="o-nav--local__item"><a href="/sjsucares/give-assistance/index.php" class="gtm-nav--local">Give Assistance </a><ul class="nested vertical menu">
               <li class="o-nav--local__item"><a href="/sjsucares/give-assistance/pantry-donation-guide.php" class="gtm-nav--local">Pantry Donation Guide</a></li>
            </ul>
         </li>
         <li class="o-nav--local__item"><a href="/sjsucares/about/index.php" class="gtm-nav--local">About</a><ul class="nested vertical menu">
               <li class="o-nav--local__item"><a href="/sjsucares/about/what-we-do.php" class="gtm-nav--local">What We Do </a></li>
               <li class="o-nav--local__item"><a href="/sjsucares/about/contact-us.php" class="gtm-nav--local">Contact Us</a></li>
               <li class="o-nav--local__item"><a href="/sjsucares/about/data.php" class="gtm-nav--local">Data and Reports</a></li>
               <li class="o-nav--local__item"><a href="/sjsucares/about/presentations.php" class="gtm-nav--local">Request a Presentation</a></li>
               <li class="o-nav--local__item"><a href="/sjsucares/about/faq.php" class="gtm-nav--local">FAQ</a></li>
               <li class="o-nav--local__item"><a href="/sjsucares/about/meet-our-director.php" class="gtm-nav--local">Meet Our Director</a></li>
            </ul>
         </li>
      </ul>
   </nav>
...
</script><script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script><p>Please note, services are offered primarily in English.</p>
         </div>
      </div>
