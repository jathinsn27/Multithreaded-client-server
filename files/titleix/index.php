   ...
   <div class="o-wrap--content">
      <nav id="sitenav-mobile" class="top-bar o-nav--site" data-topbar="data-topbar" role="navigation" aria-label="Site nav menu for small screens">
         ...
         <div id="sitenav-mobile-menu" style="min-width:100%">
            <ul class="vertical menu accordion-menu" data-accordion-menu="data-accordion-menu" data-submenu-toggle="data-submenu-toggle">
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/get-help/index.php">Get Help</a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/titleixeo/get-help/index.php">Get Help</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/get-help/our-services/index.php">Our Services</a><ul class="menu">
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/titleixeo/get-help/our-services/index.php">Our Services</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/titleixeo/get-help/our-services/definitions-of-prohibited-conduct.php">Definitions of Prohibited Conduct</a></li>
                        </ul>
                     </li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/get-help/request-a-training/index.php">Request a Training</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/get-help/privacy/index.php">Privacy</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/get-help/faqs/index.php">FAQs</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/get-help/policy-procedures/index.php">Policy &amp; Procedures</a><ul class="menu">
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/titleixeo/get-help/policy-procedures/index.php">Policy &amp; Procedures</a></li>
                           <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/titleixeo/get-help/policy-procedures/equal-opportunity-laws.php">Equal Opportunity Laws</a></li>
                        </ul>
                     </li>
                  </ul>
               </li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/resources-guides/index.php">Resources &amp; Guides</a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/titleixeo/resources-guides/index.php">Resources &amp; Guides</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/resources-guides/resolution-processes/index.php">Resolution Processes</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/resources-guides/complainant-support/index.php">Complainant Support</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/resources-guides/respondent-support/index.php">Respondent Support</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/resources-guides/witness-support/index.php">Witness Support</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/resources-guides/lgbtq-support/index.php">LGBTQIA+ Support</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/resources-guides/pregnancy-parenting-support/index.php">Pregnancy &amp; Parenting Support</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/resources-guides/confidential-resource/index.php">Confidential Resources</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/resources-guides/other-resources/index.php">Other Resources</a></li>
                  </ul>
               </li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/duty-to-report/index.php">Duty to Report</a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/titleixeo/duty-to-report/index.php">Duty to Report</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/duty-to-report/tips-for-responding/index.php">Tips for Responding</a></li>
                  </ul>
               </li>
               <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/about-us/index.php">About Us</a><ul class="menu">
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--mobile" href="/titleixeo/about-us/index.php">About Us</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/about-us/trainings-attended/index.php">Trainings Attended</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/about-us/prior-campus-updates/index.php">Prior Campus Updates</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/about-us/annual-reports/index.php">Annual Reports</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/about-us/external-reviews/index.php">External Reviews</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/about-us/department-of-justice/index.php">Department of Justice</a></li>
                     <li class="o-nav--site__item"><a class="o-nav--site__top-link" href="/titleixeo/about-us/cozen-o-connor/index.php">Cozen O'Connor</a></li>
                  </ul>
               </li>
   ...
   <div class="o-wrap--content">
      <nav id="sitenav" class="o-nav--site" role="navigation" aria-label="Site nav menu">
         <ul class="dropdown menu" data-dropdown-menu="data-dropdown-menu">
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/titleixeo/get-help/index.php">Get Help</a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/titleixeo/get-help/our-services/index.php" class="gtm-nav--site">Our&nbsp;Services</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/get-help/request-a-training/index.php" class="gtm-nav--site">Request&nbsp;a&nbsp;Training</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/get-help/privacy/index.php" class="gtm-nav--site">Privacy</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/get-help/faqs/index.php" class="gtm-nav--site">FAQs</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/get-help/policy-procedures/index.php" class="gtm-nav--site">Policy&nbsp;&amp;&nbsp;Procedures</a></li>
               </ul>
            </li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/titleixeo/resources-guides/index.php">Resources &amp; Guides</a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/titleixeo/resources-guides/resolution-processes/index.php" class="gtm-nav--site">Resolution&nbsp;Processes</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/resources-guides/complainant-support/index.php" class="gtm-nav--site">Complainant&nbsp;Support</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/resources-guides/respondent-support/index.php" class="gtm-nav--site">Respondent&nbsp;Support</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/resources-guides/witness-support/index.php" class="gtm-nav--site">Witness&nbsp;Support</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/resources-guides/lgbtq-support/index.php" class="gtm-nav--site">LGBTQIA+&nbsp;Support</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/resources-guides/pregnancy-parenting-support/index.php" class="gtm-nav--site">Pregnancy&nbsp;&amp;&nbsp;Parenting&nbsp;Support</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/resources-guides/confidential-resource/index.php" class="gtm-nav--site">Confidential&nbsp;Resources</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/resources-guides/other-resources/index.php" class="gtm-nav--site">Other&nbsp;Resources</a></li>
               </ul>
            </li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/titleixeo/duty-to-report/index.php">Duty to Report</a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/titleixeo/duty-to-report/tips-for-responding/index.php" class="gtm-nav--site">Tips&nbsp;for&nbsp;Responding</a></li>
               </ul>
            </li>
            <li class="o-nav--site__item"><a class="o-nav--site__top-link gtm-nav--site" href="/titleixeo/about-us/index.php">About Us</a><ul class="menu">
                  <li class="o-nav--site__item"><a href="/titleixeo/about-us/trainings-attended/index.php" class="gtm-nav--site">Trainings&nbsp;Attended</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/about-us/prior-campus-updates/index.php" class="gtm-nav--site">Prior&nbsp;Campus&nbsp;Updates</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/about-us/annual-reports/index.php" class="gtm-nav--site">Annual&nbsp;Reports</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/about-us/external-reviews/index.php" class="gtm-nav--site">External&nbsp;Reviews</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/about-us/department-of-justice/index.php" class="gtm-nav--site">Department&nbsp;of&nbsp;Justice</a></li>
                  <li class="o-nav--site__item"><a href="/titleixeo/about-us/cozen-o-connor/index.php" class="gtm-nav--site">Cozen&nbsp;O'Connor</a></li>
               </ul>
            </li>
               ...
               <div class="o-wrap o-wrap--media-type-hero u-bg--dark ou-error--snippet">
                  <div class="o-media o-media--hero">
                     <div class="o-media__frame">
                        <div class="o-media__graphic"><img class="o-media__img" src="/titleixeo/pics/landing-page/new-landing-page-hero-banner.png" alt="Title IX landing page picture"></div>
                     </div>
               ...
               <div class="o-wrap o-wrap--cardholder o-wrap--grid-component--DISABLE u-bg--triangles-down-small u-color--paseo-gray u-bg--fade-radial ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-cardholder u-gridgap-half">
                        <div class="o-card"><img class="o-card__img" src="/titleixeo/pics/landing-page/for-complainant.jpeg" alt="For Complainant"><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/titleixeo/resources-guides/complainant-support/index.php">For Complainants</a></p>
                           ...
                           <p class="o-c2a--card"><a class="o-c2a--card__link" href="/titleixeo/resources-guides/complainant-support/index.php"><span class="o-c2a--card__text">Learn More</span><span class="o-c2a--card__arrow"></span></a></p>
                        </div>
                        <div class="o-card"><img class="o-card__img" src="/titleixeo/pics/landing-page/for-respondent.jpeg" alt="For Respondent"><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/titleixeo/resources-guides/respondent-support/">For Respondents</a></p>
                              
                              <p class="o-card__copy">Please contact us for support and options if you have been accused of discrimination,
                                 harassment or retaliation, including sex-based misconduct.</p>
                              </div>
                           <p class="o-c2a--card"><a class="o-c2a--card__link" href="/titleixeo/resources-guides/respondent-support/index.php"><span class="o-c2a--card__text">Learn More</span><span class="o-c2a--card__arrow"></span></a></p>
                        </div>
                        <div class="o-card"><img class="o-card__img" src="/titleixeo/pics/landing-page/for-witnesses.jpeg" alt="For Witnesses"><div class="o-card__info u-gradientbar--card">
                              <p class="o-card__heading"><a class="o-card__link" href="/titleixeo/resources-guides/witness-support/index.php">For Witnesses</a></p>
                           ...
                           <p class="o-c2a--card"><a class="o-c2a--card__link" href="/titleixeo/resources-guides/witness-support/index.php"><span class="o-c2a--card__text">Learn More</span><span class="o-c2a--card__arrow"></span></a></p>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="o-wrap o-wrap--media-type-hightlight u-bg--dark ou-error--snippet">
                  <div class="o-wrap--content">
                     <div class="o-media o-media--highlight">
                        <div class="o-media__frame">
                           <div class="o-media__graphic"><img class="o-media__img" src="/titleixeo/pics/landing-page/annual-report-thumbnail.png" alt="Title IX Annual Report Interactive Dashboard AY 2022-23"><div class="o-media__photo-caption"><span class="u-icon--photo-caption-triangle u-icon--small u-color--sjsu-gold">Title IX Annual Report Interactive Dashboard AY 2022-23</span></div>
                           </div>
                        </div>
                        <div class="o-media__bg-extender">
                           <div class="o-media__frame">
               ...
               <div class="o-wrap">
                  <div class="o-wrap--content">
                     <ul id="accordion-d14e467" class="o-accordion vertical menu accordion-menu" data-accordion-menu="data-accordion-menu">
                        <li class="o-accordion__item"><a class="o-accordion__link" data-parent="#accordion-d14e467" href="#collapse-d14e467-1">SJSU’s Statement of Nondiscrimination</a><ul class="menu vertical nested" id="collapse-d14e467-1">
                        ...
                        <li class="o-accordion__item"><a class="o-accordion__link" data-parent="#accordion-d14e467" href="#collapse-d14e467-2">SJSU’s Title IX Statement of Nondiscrimination</a><ul class="menu vertical nested" id="collapse-d14e467-2">
                              <li class="o-accordion__item--nested">
                        ...
                        <li class="o-accordion__item"><a class="o-accordion__link" data-parent="#accordion-d14e467" href="#collapse-d14e467-3">What are the Protected Statuses?</a><ul class="menu vertical nested" id="collapse-d14e467-3">
                              <li class="o-accordion__item--nested">
   ...
   <div class="o-wrap--content">
      <div class="o-region--contact__label">
         ...
         <ul class="o-region--contact__social menu horizontal">
            ...
            <li><a href="#SJSUCampus" class="u-icon--social u-icon--snapchat u-color--sjsu-blue gtm-social--link"><span class="show-for-sr">PLACEHOLDER-FOR-XSL:VALUE-OF(SITE-TITLE) on Snapchat</span></a></li>
         </ul>
      </div>
   </div>
